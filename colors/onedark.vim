...
call s:h("Directory", { "fg": s:cyan }) " directory names (and other special names in listings)
...
call s:h("IncSearch", { "fg": s:visual_black, "bg": s:white }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
call s:h("LineNr", { "fg": s:visual_grey, "bg": s:gutter_bg_grey }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
